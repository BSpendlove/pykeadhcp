...
def test_kea_dhcp6_remote_option6_pool_prepare(kea_server: Kea):
    subnet = Subnet6(
        id=40123,
        subnet="2001:db8::/64",
        pools=[Pool(pool="2001:db8::2-2001:db8::ffff")],
    )
...
def test_kea_dhcp6_remote_option6_pool_cleanup(kea_server: Kea):
